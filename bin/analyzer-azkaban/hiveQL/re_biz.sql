 ...
 -- *************业务统计表_分小时
 INSERT OVERWRITE TABLE T_MID_BIZ_HOUR PARTITION(dt='${hiveconf:dt}',chn='web') 
 ...
 where   dt >= '${hiveconf:dt}'
   ...
   group by substr(query_time, 0, 8),
       ...
       city_id,insert_time;
        ...
        INSERT OVERWRITE TABLE T_MID_BIZ_HOUR PARTITION(dt='${hiveconf:dt}',chn='mob') 
select substr(query_time, 0, 8),
       substr(query_time, 9, 2),
       pay_id,
       net_id,
 ...
 where  dt >= '${hiveconf:dt}'
   ...
   group by substr(query_time, 0, 8),
       ...
       city_id,insert_time;
        ...
        INSERT OVERWRITE TABLE T_MID_BIZ_HOUR PARTITION(dt='${hiveconf:dt}',chn='sms') 
select substr(query_time, 0, 8),
       substr(query_time, 9, 2),
       pay_id,
       net_id,
